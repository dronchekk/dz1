...
extension ViewController {
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
        ...
        Alamofire.request ("http://api.vk.com/method/friends.get?access_token=\(session.token)&v=5.131").responseJSON { data in print(data.value)}
        ...
        Alamofire.request ("http://api.vk.com/method/groups.get?access_token=\(session.token)&v=5.131").responseJSON { data in print(data.value)}
